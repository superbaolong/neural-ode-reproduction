...
与 5-epoch 结果相比，两种模型均继续提升，ResNet 的提升最明显。这说明前述三 seed 短实验适合检查随机波动和代码可运行性，但不能代表充分训练后的 ResNet 上限。在本次单 seed 长训练中，ODENet 仍高出 ResNet 约 1.73 个百分点。完整命令和最终指标见 [`outputs/mnist-cloud-30`](../outputs/mnist-cloud-30/summary.md)。
